...
<div class="container" align="center">
    ...
    <div id="demo" class="collapse">
      ...
      <form id="wallform" class="form-group" role="form" style="width: 40%" action="http://localhost/Portfolio/index.php?page=postwall" method="post">
...
try {
    ...
    foreach($dbh->query('SELECT * from wall ORDER BY id DESC') as $row) {
